  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <button className={styles.btnPrimary} onClick={() => navigate('/tareas/nueva')}>
          + Nueva tarea
        </button>
      </div>
        ...
        {loading && tareas.length === 0 ? (
          ...
          <>
            <table className={styles.table}>
              ...
              <tbody>
                {tareas.map(t => (
                  <tr key={t.id} onClick={() => navigate(`/tareas/${t.id}/editar`)} style={{ cursor: 'pointer' }}>
                    ...
                    <td style={{ textAlign: 'right' }}>
                      <button className={styles.actions} onClick={(e) => { e.stopPropagation(); navigate(`/tareas/${t.id}/editar`); }}>
                        ...
                      </button>
                    </td>
                  </tr>
